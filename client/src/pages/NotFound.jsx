...
const NotFound = () => (
  <div className="min-h-[70vh] flex flex-col items-center justify-center text-center px-6 bg-stone relative">
    ...
    <div className="relative">
      ...
      <h1 className="font-display text-8xl md:text-9xl text-navy/10 font-bold">404</h1>
      <h2 className="font-display text-2xl md:text-3xl text-navy -mt-6 mb-3">Page Not Found</h2>
