...
const navItems = [
  ...
  { to: "/admin/design", label: "Design", icon: HiOutlineTemplate },
  { to: "/admin/services", label: "Construction", icon: HiOutlineBriefcase },
  { to: "/admin/blogs", label: "Blogs", icon: HiOutlineNewspaper },
  { to: "/admin/team", label: "Team", icon: HiOutlineUsers },
  { to: "/admin/messages", label: "Message", icon: HiOutlineAnnotation },
  { to: "/admin/equipment", label: "Equipment", icon: HiOutlineTruck },
